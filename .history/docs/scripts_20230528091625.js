...
document.addEventListener('DOMContentLoaded', function() {
  ...
  help.addEventListener('click', function() {
    message = "<br><br>Welcome to Chef Notes! <br>Got an idea for a recipe on the go? Enter th Name, Ingredients, and Directions into the corresponding spots in the form and hit the Save Recipe button!  "
